...
Public Class ctrlPembelian
    Private Sub ctrlPembelian_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnBatal_Click(sender As Object, e As EventArgs) Handles btnBatal.Click
        If btnBatal.Text = "&Baru" Then
            If Not RolesBasedAccessControl(frmLogin.txtUserId.Text.Trim, "pembelian", "add") Then
        ...
        If Asc(e.KeyChar) = 13 Then
            Using cfrmCariBarang As New frmCariAndEntryBarang
                Try
                    ...
                    txtKodeBarang.Text = cfrmCariBarang.grdCariBarang.CurrentRow.Cells.Item(3).Value.ToString.Trim
    ...
    Private Sub CariDataBarang(ByVal cPLU As String)
            ...
            Using Cmd As New SqlCommand()
                With Cmd
                    ...
                    .CommandText = "select [plu],[kode barang],[nama barang]," &
                                   "[satuan terkecil],[harga pokok pembelian],[kena pajak] " &
                                   "from barang where [plu] = '" & cPLU.Trim & "'"

                    Dim rDr As SqlDataReader = .ExecuteReader
                    While rDr.Read

                        If rDr.Item(5).ToString.Trim = "Y" Then
                            cPajak = "Y"
                            nPajak = Val(rDr.Item(4).ToString.Trim) * 10 / 100
                        Else
                            cPajak = "T"
                            nPajak = 0
                        End If
                        ...
                        grdPembelian.Rows.Add(New Object() {rDr.Item(0).ToString.Trim,
                                                       ...
                                                       FormatNumber(Decimal.Parse(rDr.Item(4).ToString.Trim) + Decimal.Parse(nPajak), 2)})
                    End While
                    rDr.Close()
                End With
            End Using
    ...
    Private Sub HitungSubTotal()
        ...
        grdPembelian.CurrentRow.Cells.Item(7).Value = FormatNumber((Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(4).Value)) *
                                                      Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(5).Value))) *
                                                      Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(6).Value)) / 100, 2)

        grdPembelian.CurrentRow.Cells.Item(8).Value = FormatNumber((Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(4).Value)) *
                                                                       Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(5).Value))) -
                                                                       Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(7).Value)), 2)
        If grdPembelian.CurrentRow.Cells.Item(9).Value = "Y" Then
            grdPembelian.CurrentRow.Cells.Item(10).Value = FormatNumber(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(8).Value) * 10 / 100, 2)
        Else
            grdPembelian.CurrentRow.Cells.Item(10).Value = FormatNumber(0, 2)
        End If

        grdPembelian.CurrentRow.Cells.Item(11).Value = FormatNumber(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(8).Value) +
                                                                    Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(10).Value))
    End Sub
    Private Sub grdPembelian_CellEndEdit(sender As Object, e As GridViewCellEventArgs) Handles grdPembelian.CellEndEdit
        If e.ColumnIndex = 4 Then
            If Val(grdPembelian.CurrentRow.Cells.Item(4).Value) = 0 Then
                grdPembelian.CancelEdit()
                grdPembelian.CurrentRow.Cells.Item(4).Value = Val(nQtyAwal)
            End If
            ...
            Using Cmd As New SqlCommand()
                With Cmd
                    ...
                    .Parameters.Add(New SqlParameter("@plu", SqlDbType.NChar, 15)).Value = grdPembelian.CurrentRow.Cells.Item(0).Value.ToString.Trim
                    .Parameters.Add(New SqlParameter("@harga_pokok_pembelian", SqlDbType.Decimal)).Value = Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(5).Value.ToString.Trim))
                    .Parameters.Add(New SqlParameter("@qty", SqlDbType.Decimal)).Value = Val(nQtyAwal)
                    .Parameters.Add(New SqlParameter("@qty_to", SqlDbType.Decimal)).Value = Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(4).Value.ToString.Trim))
                    .ExecuteNonQuery()
        ...
        ElseIf e.ColumnIndex = 5 Then
            grdPembelian.CurrentRow.Cells.Item(5).Value = FormatNumber(grdPembelian.CurrentRow.Cells.Item(5).Value, 2)
            HitungSubTotal()
        ElseIf e.ColumnIndex = 6 Then
            HitungSubTotal()
        ElseIf e.ColumnIndex = 7 Then
            grdPembelian.CurrentRow.Cells.Item(7).Value = FormatNumber(grdPembelian.CurrentRow.Cells.Item(7).Value, 2)
            HitungSubTotal()
        ...
        Try
            ...
            Using Cmd As New SqlCommand()
                With Cmd
                    ...
                    .Parameters.Add(New SqlParameter("@qty", SqlDbType.Decimal)).Value = Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(3).Value.ToString.Trim))
    ...
    Private Sub HitungTotal()
        Try
            ...
            For Each datarows In grdPembelian.Rows
                nSubTotal = Val(nSubTotal) + Val(Decimal.Parse(datarows.Cells.Item(8).Value.ToString.Trim))
                nSubPajak = Val(nSubPajak) + Val(Decimal.Parse(datarows.Cells.Item(10).Value.ToString.Trim))
            Next
    ...
    Private Sub SaveData()
        ...
        If grdPembelian.RowCount = 0 Then
            MsgBox("Tidak ada item barang pada grid pembelian", MsgBoxStyle.Critical, "Error")
            txtNamaBarang.Focus()
            Exit Sub
        End If
        ...
        Using Cmd As New SqlCommand()
            Try
                With Cmd
                    ...
                    dtPembelianDetail.Columns.Add("plu", GetType([String])).MaxLength = 15
                    ...
                    dtPembelianDetail.Columns.Add("disc", GetType(Decimal))
                    ...
                    For Each DataRows In grdPembelian.Rows
                        dtPembelianDetail.Rows.Add(New Object() {txtNomorFaktur.Text.Trim,
                                                                 ...
                                                                 Decimal.Parse(DataRows.Cells.Item(4).Value.ToString.Trim),
                                                                 DataRows.Cells.Item(3).Value.ToString.Trim,
                                                                 Decimal.Parse(DataRows.Cells.Item(5).Value.ToString.Trim),
                                                                 ...
                                                                 DataRows.Cells.Item(9).Value.ToString.Trim,
    ...
    Private Function HargaTerbaru(cPLU As String, nHargaPokokPembelian As Decimal) As Boolean
        ...
        Using Cmd As New SqlCommand()
            With Cmd
                .Connection = Conn
                .CommandText = "select [harga pokok pembelian],[kena pajak] from barang where [plu] = '" & cPLU.Trim & "'"

                Dim rDr As SqlDataReader = .ExecuteReader
                While rDr.Read
                    If Decimal.Parse(rDr.Item(0).ToString.Trim) <> Decimal.Parse(nHargaPokokPembelian) Then
                        UpdateHargaBarang(cPLU.Trim,
    ...
    Private Function UpdateHargaBarang(ByVal cPLU As String,
        ...
        If cKenaPajak.Trim = "Y" Then
            nPajak = Decimal.Parse(nHargaPokokPembelian) * 10 / 100
        Else
            nPajak = 0
        End If

        nHargaMarkup = Decimal.Parse(nHargaPokokPembelian) + (Decimal.Parse(nHargaPokokPembelian) * 10 / 100)
        nHargaPokokPenjualan = Decimal.Parse(nHargaPokokPembelian) + Decimal.Parse(nPajak)

        nHargaJualToko = Decimal.Parse(nHargaMarkup) + (Decimal.Parse(nHargaMarkup) * Decimal.Parse(nPersenHargaToko) / 100)
        nHargaJualGrosir = Decimal.Parse(nHargaMarkup) + (Decimal.Parse(nHargaMarkup) * Decimal.Parse(nPersenHargaGrosir) / 100)
        ...
        Try
            ...
            Using Cmd As New SqlCommand()
                With Cmd
                    ...
                    .Parameters.Add(New SqlParameter("@harga_pokok_pembelian", SqlDbType.Decimal, 18, 2)).Value = Decimal.Parse(nHargaPokokPembelian)
                    .Parameters.Add(New SqlParameter("@kena_pajak", SqlDbType.NChar, 1)).Value = cKenaPajak.Trim
                    .Parameters.Add(New SqlParameter("@ppn_masuk", SqlDbType.Decimal, 18, 2)).Value = Decimal.Parse(nPajak)
                    .Parameters.Add(New SqlParameter("@harga_pokok_penjualan", SqlDbType.Decimal, 18, 2)).Value = Decimal.Parse(nHargaPokokPenjualan)
                    .Parameters.Add(New SqlParameter("@harga_jual_toko", SqlDbType.Decimal, 18, 2)).Value = Decimal.Parse(nHargaJualToko)
                    .Parameters.Add(New SqlParameter("@harga_jual_grosir", SqlDbType.Decimal, 18, 2)).Value = Decimal.Parse(nHargaJualGrosir)
                    .ExecuteNonQuery()
    ...
    Private Sub EditItem()
        Try
            nQtyAwal = 0
            nQtyAwal = Val(grdPembelian.CurrentRow.Cells.Item(4).Value)
            grdPembelian.CurrentRow.Cells.Item(4).BeginEdit()
        Catch ex As Exception
    ...
    Private Sub grdPembelian_CellBeginEdit(sender As Object, e As GridViewCellCancelEventArgs) Handles grdPembelian.CellBeginEdit
        If e.ColumnIndex = 4 Then
            nQtyAwal = 0
            nQtyAwal = Val(Decimal.Parse(grdPembelian.CurrentRow.Cells.Item(4).Value))
            grdPembelian.CurrentRow.Cells.Item(4).BeginEdit()
        End If
    End Sub
    ...
    Private Sub btnKoreksi_Click(sender As Object, e As EventArgs) Handles btnKoreksi.Click
        ...
        Using cfrmListPembelian As New frmListPembelian
            ...
            If cfrmListPembelian.cCrudAction.Trim = "crud-edit" Then
                lNew = False
                ClearHeader()
                ClearDetail()
                ClearFooter()
                EnableText()
                grdPembelian.Rows.Clear()
                EditData(cfrmListPembelian.cNomorFaktur.Trim)
                HitungTotal()
            End If
        End Using
    End Sub

    Private Sub EditData(ByVal cNomorFaktur As String)
        Dim Conn As SqlConnection = clsPublic.KoneksiSQL
        Conn.Open()
        ...
        Using Cmd As New SqlCommand()
            With Cmd
                ...
                .CommandText = "SELECT pembelian_detail.[plu]," &
                               "pembelian_detail.[kode barang]," &
                               "barang.[nama barang]," &
                               "pembelian_detail.[satuan]," &
                               "pembelian_detail.[qty]," &
                               "pembelian_detail.[harga pokok pembelian]," &
                               "pembelian_detail.[disc]," &
                               "pembelian_detail.[discount]," &
                               "pembelian_detail.[sub total]," &
                               "pembelian_detail.[pajak]," &
                               "pembelian_detail.[besar pajak] " &
                               "FROM pembelian_detail pembelian_detail " &
                               "INNER JOIN barang barang ON pembelian_detail.[plu] = barang.[plu] " &
                ...
                While rDr.Read
                    grdPembelian.Rows.Add(New Object() {
                                          ...
                                          rDr.Item(2).ToString.Trim,
                                          rDr.Item(3).ToString.Trim,
                                          FormatNumber(Decimal.Parse(rDr.Item(4).ToString.Trim), 2),
                                          FormatNumber(Decimal.Parse(rDr.Item(5).ToString.Trim), 2),
                                          ...
                                          FormatNumber(Decimal.Parse(rDr.Item(8).ToString.Trim) +
                                          Decimal.Parse(rDr.Item(10).ToString.Trim), 2)})
                End While
                rDr.Close()
            End With
        End Using
